...
void ejercicio2(int a, int b, int c, int d)
{
    ...
    //MODIFICAR
    list<string>::iterator iter = mi_lista.begin();
    advance(iter, a);
    e = *iter;
    iter = mi_lista.begin();
    advance(iter, b);
...
void ejercicio4(int i,int j,int k,int l)
{
    ...
    cout<<"Int en el archivo en la posicion i: "<<*m<<endl;
    cout<<"Int en el archivo en la posicion j: "<<*n<<endl;
    cout<<"Int en el archivo en la posicion k: "<<*o<<endl;
    cout<<"Int en el archivo en la posicion l: "<<*p<<endl;
}
